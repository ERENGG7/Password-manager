// Dear ImGui: standalone example application for Wind#include "imgui_impl_win32.h"
...
// Data
static LPDIRECT3DTEXTURE9 g_ButtonTexture = nullptr;
...
int main(int, char**) {
	...
	while (!done)
	{
		...
		BeginFrame();
		//creating window by flag open:
		if (open) {
			//TODO: password manager ui-logic!
			//TODO: init program class!
			password_manager.drawUI(open);
		}
		EndFrame();
